...
Исходя из имеющихся данных о заболеваемости в разных странах, модель делает предсказания заболеваемости на 30 дней. Подробно о модели можно прочитать в [`Отчете о научно-исследовательской работе`](docs/source/research_report.md).
