...
- **MAPE, Mean Absolute Percent Error (средняя абсолютная ошибка в процентах)**—  эта метрика показывает, на сколько процентов в среднем наше предсказание отклоняется от реального значения. 
...
Для третьего (*n-ного) метода прогнозирования было решено рассмотреть «случайный процесс, состоящий из сигнала, отражающего реальную эпидемическую ситуацию, и высокочастотного шума». Экспоненциальное сглаживание может справиться с такой изменчивостью внутри ряда, сглаживая шум. 
